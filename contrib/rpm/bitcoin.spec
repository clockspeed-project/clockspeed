...
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 5188
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 44229
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 5189
...
if [ $1 -eq 0 ]; then
	...
	%{_sbindir}/semanage port -d -p tcp 5188
	%{_sbindir}/semanage port -d -p tcp 44229
	%{_sbindir}/semanage port -d -p tcp 5189
